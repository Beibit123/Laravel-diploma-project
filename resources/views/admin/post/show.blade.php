...
@section('content')
    ...
    <div class="mb-2" style="display:flex; gap: 10px;">
        <a href="{{ route('admin.post.edit', $post->id) }}"><button type="button" class="btn btn-warning">Изменить</button></a>
    ...
    <div class="border rounded">
      ...
      <div class="p-3 mb-1 bg-light text-dark"><label class="col col-form-label"><b>Превью: <b></label><img class="img-thumbnail" src="{{ url('storage/' . $post->preview_image) }}" alt="preview_image"></div>
      <div class="p-3 mb-1 bg-light text-dark"><label class="col col-form-label"><b>Главное изображение: <b></label><img class="img-thumbnail" src="{{ url('storage/' . $post->main_image) }}" alt="main_image"></div>
  </div>
@endsection
